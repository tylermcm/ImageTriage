...
def build_primary_toolbar(window, actions: MainWindowActions) -> QToolBar:
    ...
    ai_training_menu = QMenu("Training", toolbar)
    ai_training_menu.addAction(actions.build_culling_signals)
    ai_training_menu.addAction(actions.tune_culling_signals)
    ai_training_menu.addAction(actions.evaluate_culling_signals)
    _add_toolbar_menu(toolbar, text="Training", menu=ai_training_menu, min_width=104)
